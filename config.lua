...
Garages = {
    ...
    ["sapcounsel"] = {
        ...
        takeVehicle = vector3(-229.14, 924.9, 11.11),
        spawnPoint = vector4(-223.7, 927.16, 9.76, 0.04),
        putVehicle = vector3(-222.84, 928.05, 9.75),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
    ...
    ["spanishave"] = {
        label = "Topaz Ave Parking",
        takeVehicle = vector3(-78.4, 1691.01, 15.12),
        spawnPoint = vector4(-71.2, 1674.88, 14.04, 89.43),
        putVehicle = vector3(-70.79, 1689.74, 14.48),
        showBlip = true,
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
    ...
    ["impoundlot"] = {
        label = "Impound Lot",
        takeVehicle = vector3(-381.75, 1592.7, 10.33),
        spawnPoint = vector4(-26.96, -90.99, 4.36, 209.1),
        showBlip = true,
    ...
    ["police"] = {
        label = "Police",
        takeVehicle = vector3(315.82, 1746.58, 16.0),
        spawnPoint = vector4(309.36, 1742.09, 16.0, 266.7),
        putVehicle = vector3(307.76, 1751.1, 16.0),
        showBlip = false,
        blipName = "Police",
        blipNumber = 357,
